...
function (_React$Component) {
  ...
  function DanteInlineTooltip(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "insertImage", function (file) {
      ...
      if (type === "image") {
        _this.props.onChange((0, _index.addNewBlock)(_this.props.editorState, "image", opts));
      }

      if (type === "video") {
        _this.props.onChange((0, _index.addNewBlock)(_this.props.editorState, "video", opts));
      }
    });
